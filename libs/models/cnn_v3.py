"""
    Simple vanilla CNN model like v2 but the batchnorm layers have been changed in order.
    The reason is that in metadata wherenot normalized in the previous version with batch norm
...
def my_model_builder(
    ...
    def my_cnn_model(my_cnn_encoder, my_head):
        ...
        return tf.keras.Model([img_input, metadata_input], x, name='cnn_v3')
