"""
    Simple vanilla CNN model like v3 but with more capacity (7.5m parameters).
    Remove the global average pooling and use max pooling layers within the body.

    The reason is that the CNN v3 has got some bias compared to CNN v2.
...
def my_model_builder(
    ...
    def my_cnn_model(my_cnn_encoder, my_head):
        ...
        return tf.keras.Model([img_input, metadata_input], x, name='cnn_v4')
